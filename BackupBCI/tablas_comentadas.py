...
estructura = {'Nombre Proceso':[],'Tablas No Comentadas':[],'Tablas Comentadas':[]}
...
if os.path.exists(filename):
  ...
  lenCodigo = len(listaCodigoFinal)
  lenComentario = len(listaBdComentarios2)
  ...
  for i in range(0,lenCodigo2):
    listaCodigoFinal.append('')

  for i in range(0,lenComentario2):
    listaBdComentarios2.append('')  
  ...
  for elemento in listaCodigoFinal:
    estructura['Tablas No Comentadas'].append(elemento)
  for elemento in listaBdComentarios2:
    estructura['Tablas Comentadas'].append(elemento)
else:
